...
export default async function ClientDropboxConnectPage() {
        ...
        {isConnected ? (
          <>
            ...
            <p className="text-sm text-[#8B8D93]">
              Your Dropbox account is linked. Project and role folders will be
              created automatically in your Dropbox.
            </p>
          </>
        ) : !dropboxConfigured ? (
          <>
          ...
          <>
            ...
            <p className="text-sm text-[#8B8D93] mb-6">
              Connect Dropbox to automatically organize your casting projects
              with folders for each project and role.
            </p>
            <a
              href={authUrl!}
